...
class MakanMalamFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_makan_malam, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        titleTextView.text = "Makan Malam"
    ...
    private fun fetchDataMakanMalam() {
        ...
        val path = "users/$uid/history/$currentDate/Makan Malam"
    ...
    private fun fetchUserData(
        ...
        userRef.get().addOnSuccessListener { document ->
            if (document != null && document.exists()) {
                ...
                view?.apply {
                    findViewById<TextView>(R.id.tvKalori).text =
                        "${String.format("%.1f", totalKalori)}/${String.format("%.1f", maksimalKalori)}g"
                    findViewById<TextView>(R.id.tvKarbo).text =
                    ...
                    findViewById<TextView>(R.id.tvLemak).text =
                        "${String.format("%.1f", totalLemak)}/${String.format("%.1f", maksimalLemak)}g"

                    findViewById<ProgressBar>(R.id.progressKalori).progress = persenKalori
                    findViewById<ProgressBar>(R.id.progressKarbo).progress = persenKarbo
                    findViewById<ProgressBar>(R.id.progressProtein).progress = persenProtein
                    findViewById<ProgressBar>(R.id.progressLemak).progress = persenLemak
                }
            }
        }.addOnFailureListener {
